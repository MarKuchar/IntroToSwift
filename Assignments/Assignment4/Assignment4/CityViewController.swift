...
class CityViewController: UIViewController {
  ...
  @objc func showWeatherDetails() {
        ...
        detailView.particularCountryImage.image = UIImage(named:city.icon + "-1")
        detailView.particularCityLabel.text = city.name
        detailView.particularTemperatureLabel.text = String(city.temp)
        detailView.particularSummaryLabel.text = city.summary
