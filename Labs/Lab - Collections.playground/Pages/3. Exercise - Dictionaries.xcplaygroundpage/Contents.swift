 ...
 */
dayInMonth["February"] = 29
print(dayInMonth)
/*:
 Use if-let syntax to retrieve the number of days under "January". If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
 */

if let isThere = dayInMonth["January"] {
    print(isThere)
}
...
var dic = ["shapesArray": shapesArray, "coloursArray": colorsArray]
print(dic)
/*:
 ...
 */
print(dic["shapesArray"]![shapesArray.count - 1])
