...
print(somePlace.longtitude, somePlace.latitude)
...
var favoriteBook = Book(title: "1984", author: "George Orwell", pages: 100, price: 15.4)
/*:
 ...
 */
struct Height {
    var heighInInches: Double
    init(heigh: Double) {
        self.heighInInches = heigh
    }
    
}
var h = Height(heigh: 321.2)
/*:
