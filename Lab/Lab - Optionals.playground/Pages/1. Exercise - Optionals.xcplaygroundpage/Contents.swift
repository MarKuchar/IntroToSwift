...
*/
let userInputAge: String = "34w"
// let userAge: Int = Int.init(userInputAge) - Value of optional type 'Int?' must be unwrapped to a value of type 'Int' error
let userAge: Int? = Int.init(userInputAge)
/*:
