...
func food(meal: String) -> Meal? {
    if let foody = meals[meal] {
        return foody
    }
    return nil
}
print(food(meal: "Breakfast")!)
print(food(meal: "Lunch"))
/*:
...
func mealy(meal: String) -> [String: Any]? {
   if let food = UserDefaults.standard.dictionary(forKey: meal) {
        return food
    }
    return nil
}
print(mealy(meal: "mealLog"))
